...
public class SpartanAPIvsDB extends SpartanTestBase {
    ...
    public void testDB1(){
        ...
        //Let's start with database. Get the database from query (SQL Developer)

        String query = "select spartan_id,name,gender,phone from spartans\n" +
                "where spartan_id = 15";

        //save the data inside the map
        ...
        //3. compare (Use Junit assertion or Hamcrest assertion) We will go with Hamcrest
